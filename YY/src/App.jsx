  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/admin/test-results" element={<AdminProtectedRoute><AdminDashboard /></AdminProtectedRoute>} />
        <Route path="/admin/payment-history" element={<AdminProtectedRoute><AdminDashboard /></AdminProtectedRoute>} />
